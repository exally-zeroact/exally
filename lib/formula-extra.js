    ...
    return {
      ...
      足さない: {
        /* ★★2026-09-06 実測＝ここに 書いてあった 5個は 動いていた★★
           ...
           ★残る 3つは 押しても #NAME?★（実測） */
        'LAMBDA': '★その場で 呼ぶ 書き方（=LAMBDA(x,x+1)(4)）は 動く★。'
        ...
        'ODDFPRICE': '端数の 初回が 1期に 収まる 形なら 実Excel と 合うが、'
          + '日数の 数え方 2・3 や 準期間 3つ以上で ずれる（2026-09-07 実測）。'
          + '半分 合う 答えは 出さないと 決めた。合う 形だけ 切り出せるように なったら 出す',
        'ODDFYIELD': '端数の 初回が 有る 債券の 利回り。ODDFPRICE と 同じ 訳で 出していない（2026-09-07 実測）',
