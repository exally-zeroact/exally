          ...
          chain = chain.then(function () {
            ...
            return zip.bytes(pn).then(function (b) {
              ...
              for (var i = 0; i < recs.length; i++) {
                ...
                var res = rewriteXlsbFormula(f, lists, byId, { row: 行, sheet: sn });
                if (res === null) {
                  stats.refused++;
