...
(function (root) {
  ...
  function 読む(o) {
    ...
    if (合言葉 === 'shitaku_tarinai') return 支度足りない();
  ...
  /* ★うちの 支度が 足りない時★（2026-09-05 指示役）
     ＝AIに 渡す 前置きの ファイル(prompt/*.md)が 読めなかった 等。
     ★前は 500 を 返していたので ★AI側() が 出て「AI側で 失敗しました」と 嘘を 言った★★
     ⇒ お客さんは AI を 疑い、管理者も AI を 疑い、★誰も うちを 見ない★。
     ⇒★うちの 落ち度は うちの 落ち度と 言う★。 */
  function 支度足りない() {
    return 作る('うちの 支度が 足りませんでした。',
      '押し直しても 直りません。管理者に「AIに渡す前置きが読めていない」と伝えてね。');
  }
