# toru-oddf-nokori25.ps1 -- ★組1 と 組2 の 準日を 直に 見る★（㈞）（2026-09-19）
#
#  ★順は 散らして います★（種 1231）
...
$出 = Join-Path $ここ 'golden-oddf-nokori25-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2008,1,1), DATE(2012,6,30), DATE(2007,11,20), DATE(2008,6,30), 0.055, 0, 100, 2, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,3), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,25), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2007,12,30), DATE(2012,6,30), DATE(2007,11,20), DATE(2008,6,30), 0.055, 0, 100, 2, 1)' },
  @{ 番 = '6'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,4), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '7'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,24), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '8'; 式 = '=ODDFPRICE(DATE(2007,12,29), DATE(2012,6,30), DATE(2007,11,20), DATE(2008,6,30), 0.055, 0, 100, 2, 1)' },
  @{ 番 = '9'; 式 = '=ODDFPRICE(DATE(2007,12,31), DATE(2012,6,30), DATE(2007,11,20), DATE(2008,6,30), 0.055, 0, 100, 2, 1)' }
)
