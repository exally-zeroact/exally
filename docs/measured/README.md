...
## `exally-missing-2026-09-07.txt` … ★Exally で 動かない 43個★（09-06 の 65個から 22個 減った）

```
 ★09-07 に お金の 関数 22個を 足した★（債券・減価償却）
 ⇒ カバー率 ★454/519（87.5%）→ 476/519（91.7%）★
 ★古い 09-06 の 紙は 消していません★
   ⇒★いつ 何が 動くように なったかが 追える★
 ★どうやって 決めたか★ … `docs/measured/kansuu46/README.md`
   （実Excel に 700本 打たせて 1本ずつ 突き合わせた）
```
