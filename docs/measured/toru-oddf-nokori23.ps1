# toru-oddf-nokori23.ps1 -- ★組C と 組D 16本★（㈜）（2026-09-19）
#
#  ★組C★ 満 2013-06-30 / 発 2009-01-15 / 初 2009-09-30 = ★ 2月を 1度も 通りません★
#  ★組D★ 満 2013-02-28 / 発 2008-12-05 / 初 2009-08-28 = ★ 28日 なので 丸まりません★
#  ★順は 散らして います★（種 630）
...
$出 = Join-Path $ここ 'golden-oddf-nokori23-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2009,4,30), DATE(2013,2,28), DATE(2008,12,5), DATE(2009,8,28), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,6,30), DATE(2013,6,30), DATE(2009,1,15), DATE(2009,9,30), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,4,15), DATE(2013,2,28), DATE(2008,12,5), DATE(2009,8,28), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,4,5), DATE(2013,6,30), DATE(2009,1,15), DATE(2009,9,30), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2009,6,29), DATE(2013,6,30), DATE(2009,1,15), DATE(2009,9,30), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '6'; 式 = '=ODDFPRICE(DATE(2009,5,15), DATE(2013,2,28), DATE(2008,12,5), DATE(2009,8,28), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '7'; 式 = '=ODDFPRICE(DATE(2009,4,28), DATE(2013,2,28), DATE(2008,12,5), DATE(2009,8,28), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '8'; 式 = '=ODDFPRICE(DATE(2009,5,15), DATE(2013,6,30), DATE(2009,1,15), DATE(2009,9,30), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '9'; 式 = '=ODDFPRICE(DATE(2009,5,28), DATE(2013,2,28), DATE(2008,12,5), DATE(2009,8,28), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '10'; 式 = '=ODDFPRICE(DATE(2009,5,30), DATE(2013,6,30), DATE(2009,1,15), DATE(2009,9,30), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '11'; 式 = '=ODDFPRICE(DATE(2009,6,15), DATE(2013,6,30), DATE(2009,1,15), DATE(2009,9,30), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '12'; 式 = '=ODDFPRICE(DATE(2009,3,31), DATE(2013,2,28), DATE(2008,12,5), DATE(2009,8,28), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '13'; 式 = '=ODDFPRICE(DATE(2009,4,30), DATE(2013,6,30), DATE(2009,1,15), DATE(2009,9,30), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '14'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2013,2,28), DATE(2008,12,5), DATE(2009,8,28), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '15'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '16'; 式 = '=ODDFPRICE(DATE(2009,5,31), DATE(2013,6,30), DATE(2009,1,15), DATE(2009,9,30), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '17'; 式 = '=ODDFPRICE(DATE(2009,5,27), DATE(2013,2,28), DATE(2008,12,5), DATE(2009,8,28), 0, 0.05, 100, 4, 1)' }
)
