# toru-oddf-nokori15.ps1 -- ★境界を 挟む 3本組★（㈓の次）（2026-09-19）
#
#  ★出どころ★ ... Exally1 の 便り（★紙には まだ 在りません★）
#    ⇒★★数を 見る 前に 式を 見て ください★★
#
#  ★対照★ ... golden-oddf-nokori-2026-09-18.tsv = ★96.1767213744142★
#    ⇒★同じ 数に ならなければ この 回は 捨てます★
#
#   1  発11-27 (準日の 1日前) 利率0
#   2  発11-27 (準日の 1日前) 利回り0
#   3  発11-27 (準日の 1日前) 両方
#   4  発11-29 (準日の 1日後) 利率0
#   5  発11-29 (準日の 1日後) 利回り0
#   6  発11-29 (準日の 1日後) 両方
#   7  決05-30 (準日の 1日前) 利率0
#   8  決05-30 (準日の 1日前) 利回り0
#   9  決05-30 (準日の 1日前) 両方
#  10  決06-01 (準日の 1日後) 利率0
#  11  決06-01 (準日の 1日後) 利回り0
#  12  決06-01 (準日の 1日後) 両方
#  13  対照 (golden-oddf-nokori-2026-09-18.tsv = 96.1767213744142)
#
#
...
$出 = Join-Path $ここ 'golden-oddf-nokori15-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,27), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,27), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,27), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,29), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,29), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '6'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,29), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '7'; 式 = '=ODDFPRICE(DATE(2009,5,30), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '8'; 式 = '=ODDFPRICE(DATE(2009,5,30), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '9'; 式 = '=ODDFPRICE(DATE(2009,5,30), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '10'; 式 = '=ODDFPRICE(DATE(2009,6,1), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '11'; 式 = '=ODDFPRICE(DATE(2009,6,1), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '12'; 式 = '=ODDFPRICE(DATE(2009,6,1), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '13'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' }
)
