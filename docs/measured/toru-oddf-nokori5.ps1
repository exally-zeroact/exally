# toru-oddf-nokori5.ps1 -- ★ODDF の 残り 1本 と ODDL の 6本を 実Excel に 聞く★（2026-09-18）
#
...
$出 = Join-Path $ここ 'golden-oddf-nokori5-2026-09-18.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDLPRICE(DATE(2009,2,28), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '2'; 式 = '=ODDLPRICE(DATE(2009,2,28), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '3'; 式 = '=ODDLPRICE(DATE(2009,2,28), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '4'; 式 = '=ODDLPRICE(DATE(2009,3,1), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '5'; 式 = '=ODDLPRICE(DATE(2009,3,1), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '6'; 式 = '=ODDLPRICE(DATE(2009,3,1), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '7'; 式 = '=ODDLPRICE(DATE(2009,5,1), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '8'; 式 = '=ODDLPRICE(DATE(2009,5,1), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '9'; 式 = '=ODDLPRICE(DATE(2009,5,1), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '10'; 式 = '=ODDLPRICE(DATE(2009,5,15), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '11'; 式 = '=ODDLPRICE(DATE(2009,5,15), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '12'; 式 = '=ODDLPRICE(DATE(2009,5,15), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '13'; 式 = '=ODDLPRICE(DATE(2009,5,29), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '14'; 式 = '=ODDLPRICE(DATE(2009,5,29), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '15'; 式 = '=ODDLPRICE(DATE(2009,5,29), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '16'; 式 = '=COUPDAYBS(DATE(2009,2,28), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '17'; 式 = '=COUPDAYBS(DATE(2009,3,1), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '18'; 式 = '=COUPDAYBS(DATE(2009,5,1), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '19'; 式 = '=COUPDAYBS(DATE(2009,5,15), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '20'; 式 = '=COUPDAYBS(DATE(2009,5,29), DATE(2009,8,31), 4, 0)' }
)
