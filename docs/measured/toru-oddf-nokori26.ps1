# toru-oddf-nokori26.ps1 -- ★組E 発行を 8日 掃く★（㈟）（2026-09-19）
#
#  ★順は 散らして います★（種 229）
...
$出 = Join-Path $ここ 'golden-oddf-nokori26-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2009,6,10), DATE(2015,5,31), DATE(2009,3,3), DATE(2009,11,30), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,6,10), DATE(2015,5,31), DATE(2009,2,25), DATE(2009,11,30), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,6,10), DATE(2015,5,31), DATE(2009,3,2), DATE(2009,11,30), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,6,10), DATE(2015,5,31), DATE(2009,3,4), DATE(2009,11,30), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2009,6,10), DATE(2015,5,31), DATE(2009,2,28), DATE(2009,11,30), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '6'; 式 = '=ODDFPRICE(DATE(2009,6,10), DATE(2015,5,31), DATE(2009,3,1), DATE(2009,11,30), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '7'; 式 = '=ODDFPRICE(DATE(2009,6,10), DATE(2015,5,31), DATE(2009,2,26), DATE(2009,11,30), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '8'; 式 = '=ODDFPRICE(DATE(2009,6,10), DATE(2015,5,31), DATE(2009,2,27), DATE(2009,11,30), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '9'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' }
)
