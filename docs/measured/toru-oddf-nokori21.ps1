# toru-oddf-nokori21.ps1 -- ★ 2009-04-21 から 05-14 まで 1日ずつ 24本★（2026-09-19）
#
#  ★順は 散らして います★（種 514）
...
$出 = Join-Path $ここ 'golden-oddf-nokori21-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2009,4,29), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,5,14), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,4,22), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,4,23), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2009,5,12), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '6'; 式 = '=ODDFPRICE(DATE(2009,5,6), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '7'; 式 = '=ODDFPRICE(DATE(2009,5,1), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '8'; 式 = '=ODDFPRICE(DATE(2009,4,21), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '9'; 式 = '=ODDFPRICE(DATE(2009,5,5), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '10'; 式 = '=ODDFPRICE(DATE(2009,4,28), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '11'; 式 = '=ODDFPRICE(DATE(2009,5,7), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '12'; 式 = '=ODDFPRICE(DATE(2009,5,3), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '13'; 式 = '=ODDFPRICE(DATE(2009,4,26), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '14'; 式 = '=ODDFPRICE(DATE(2009,4,30), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '15'; 式 = '=ODDFPRICE(DATE(2009,5,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '16'; 式 = '=ODDFPRICE(DATE(2009,5,8), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '17'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '18'; 式 = '=ODDFPRICE(DATE(2009,5,9), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '19'; 式 = '=ODDFPRICE(DATE(2009,5,4), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '20'; 式 = '=ODDFPRICE(DATE(2009,4,25), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '21'; 式 = '=ODDFPRICE(DATE(2009,4,27), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '22'; 式 = '=ODDFPRICE(DATE(2009,5,13), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '23'; 式 = '=ODDFPRICE(DATE(2009,5,11), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '24'; 式 = '=ODDFPRICE(DATE(2009,4,24), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '25'; 式 = '=ODDFPRICE(DATE(2009,5,2), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' }
)
