/* ★お金4関数の 紙を ★うちの 本番の 道★で 押して 突き合わせる★（2026-09-09・2件目）
 *
 *  ★正★ … `golden-okane-4kansuu-2026-09-09.tsv`（実Excel の 実測）
...
const 紙 = path.join(ROOT, 'docs/measured/golden-okane-4kansuu-2026-09-09.tsv');
...
言う('# ★お金4関数の 紙を うちの 本番の 道で 押して 突き合わせた★（2026-09-09・2件目）');
言う('#');
言う('# ★正★ golden-okane-4kansuu-2026-09-09.tsv（実Excel の 実測）');
