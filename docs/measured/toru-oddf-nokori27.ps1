# toru-oddf-nokori27.ps1 -- ★本当の 隙間を 掃く（2008-08-29,30 と 2008-05-29,30）★（2026-09-19）
#
#  ★順は 散らして います★（種 829）
...
$出 = Join-Path $ここ 'golden-oddf-nokori27-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,8,28), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,9,1), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,8,29), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,5,30), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,5,29), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '6'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,5,27), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '7'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,5,31), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '8'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,6,1), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '9'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,8,27), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '10'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '11'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,5,28), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '12'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,8,31), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '13'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,8,30), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' }
)
