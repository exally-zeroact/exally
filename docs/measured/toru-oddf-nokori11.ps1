# toru-oddf-nokori11.ps1 -- ★ODDF の 残り 1本 と ODDL の 6本を 実Excel に 聞く★（2026-09-18）
#
...
$出 = Join-Path $ここ 'golden-oddf-nokori11-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDLPRICE(DATE(2009,6,15), DATE(2010,2,28), DATE(2009,1,31), 0.06, 0, 100,1,0)' },
  @{ 番 = '2'; 式 = '=ODDLPRICE(DATE(2009,6,15), DATE(2010,2,28), DATE(2009,1,31), 0, 0.05, 100,1,0)' },
  @{ 番 = '3'; 式 = '=ODDLPRICE(DATE(2009,6,15), DATE(2010,2,28), DATE(2009,1,31), 0.06, 0.05, 100,1,0)' },
  @{ 番 = '4'; 式 = '=ODDLPRICE(DATE(2009,6,15), DATE(2010,2,27), DATE(2009,1,31), 0.06, 0, 100,1,0)' },
  @{ 番 = '5'; 式 = '=ODDLPRICE(DATE(2009,6,15), DATE(2010,2,27), DATE(2009,1,31), 0, 0.05, 100,1,0)' },
  @{ 番 = '6'; 式 = '=ODDLPRICE(DATE(2009,6,15), DATE(2010,2,27), DATE(2009,1,31), 0.06, 0.05, 100,1,0)' },
  @{ 番 = '7'; 式 = '=ODDLPRICE(DATE(2009,6,15), DATE(2010,3,31), DATE(2009,1,31), 0.06, 0, 100,1,0)' },
  @{ 番 = '8'; 式 = '=ODDLPRICE(DATE(2009,6,15), DATE(2010,3,31), DATE(2009,1,31), 0, 0.05, 100,1,0)' },
  @{ 番 = '9'; 式 = '=ODDLPRICE(DATE(2009,6,15), DATE(2010,3,31), DATE(2009,1,31), 0.06, 0.05, 100,1,0)' }
)
