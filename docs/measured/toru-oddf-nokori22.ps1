# toru-oddf-nokori22.ps1 -- ★準日が 15日の 組 11本★（㈛）（2026-09-19）
#
#  ★満 2013-02-15 / 発 2008-12-05 / 初 2009-08-15 / f=4 / basis 1★
#  ★月末と EDATE が 別の 日に なる 組★
#  ★順は 散らして います★（種 215）
...
$出 = Join-Path $ここ 'golden-oddf-nokori22-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2009,3,15), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,4,16), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,4,15), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,3,16), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2009,5,1), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '6'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '7'; 式 = '=ODDFPRICE(DATE(2009,4,30), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '8'; 式 = '=ODDFPRICE(DATE(2009,3,31), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '9'; 式 = '=ODDFPRICE(DATE(2009,3,14), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '10'; 式 = '=ODDFPRICE(DATE(2009,4,14), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '11'; 式 = '=ODDFPRICE(DATE(2009,5,14), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '12'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2013,2,15), DATE(2008,12,5), DATE(2009,8,15), 0, 0.05, 100, 4, 1)' }
)
