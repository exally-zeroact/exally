# toru-oddf-nokori12.ps1 -- ★ODDF の 3本組 15本を 実Excel に 聞く（㈑）★（2026-09-19）
#
...
$出 = Join-Path $ここ 'golden-oddf-nokori12-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0, 100, 4, 0)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 0)' },
  @{ 番 = '6'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 0)' },
  @{ 番 = '7'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,28), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '8'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,28), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '9'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,28), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '10'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,30), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '11'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,30), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '12'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,30), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '13'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,1), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '14'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,1), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '15'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,1), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' }
)
...
try {
  ...
  $行.Add('# ★ODDF の 3本組 15本を 実Excel に 聞いた（㈑・Exally1 の 註文）★（2026-09-19）')
  $行.Add('#')
