# toru-oddf-nokori19.ps1 -- ★ 04-15 を 挠む★（㈘）（2026-09-19）
#
#  ★同じ 式を わざと 2本 入れて います★ = ★同じ 紙の 中で 2回 同じ 数か★
#  ★順は 散らして います★（種 315）
#  ★対照★ ... golden-oddf-nokori-2026-09-18.tsv = ★96.1767213744142★
#
#  1  2009-03-25 (tsugi no junbi made 67 nichi)
#  2  2009-04-15 (tsugi no junbi made 46 nichi) [2kaime  ONAJI SHIKI]
#  3  2009-04-15 (tsugi no junbi made 46 nichi) [1kaime]
#  4  2009-04-10 (tsugi no junbi made 51 nichi)
#  5  taisho (golden-oddf-nokori-2026-09-18.tsv = 96.1767213744142)
#  6  2009-04-20 (tsugi no junbi made 41 nichi)
#
#
...
$出 = Join-Path $ここ 'golden-oddf-nokori19-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2009,3,25), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,4,15), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,4,15), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,4,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
