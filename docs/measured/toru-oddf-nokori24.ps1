# toru-oddf-nokori24.ps1 -- ★残り 2本の 因 と 月末の組の 割れ★（㈝）（2026-09-19）
#
#  ★順は 散らして います★（種 1129）
...
$出 = Join-Path $ここ 'golden-oddf-nokori24-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2008,1,15), DATE(2012,6,30), DATE(2007,11,20), DATE(2008,6,30), 0, 0.055, 100, 2, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2007,12,31), DATE(2012,6,30), DATE(2007,11,20), DATE(2008,6,30), 0, 0.055, 100, 2, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2008,5,31), DATE(2012,6,30), DATE(2007,11,20), DATE(2008,6,30), 0, 0.055, 100, 2, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2008,2,15), DATE(2012,6,30), DATE(2007,11,20), DATE(2008,6,30), 0, 0.055, 100, 2, 1)' },
  @{ 番 = '6'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,2), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '7'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,12,1), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '8'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,29), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '9'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,27), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '10'; 式 = '=ODDFPRICE(DATE(2009,3,10), DATE(2015,2,28), DATE(2008,11,26), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '11'; 式 = '=ODDFPRICE(DATE(2007,12,30), DATE(2012,6,30), DATE(2007,11,20), DATE(2008,6,30), 0, 0.055, 100, 2, 1)' }
)
