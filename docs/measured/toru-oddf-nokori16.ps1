# toru-oddf-nokori16.ps1 -- ★残り 3本の 3本組★（㈔）（2026-09-19）
#
#  ★出どころ★ ... Exally1 の 便り
#  ★対照★ ... golden-oddf-nokori-2026-09-18.tsv = ★96.1767213744142★
#
#  1  kumi1 ket05-31 hak12-05 riritsu0
#  2  kumi1 ket05-31 hak12-05 mawari0
#  3  kumi3 ket05-31 hak11-28 riritsu0
#  4  kumi3 ket05-31 hak11-28 mawari0
#  5  kumi3 ket05-31 hak11-28 ryouhou
#  6  taisho (golden-oddf-nokori-2026-09-18.tsv = 96.1767213744142)
#
#
...
$出 = Join-Path $ここ 'golden-oddf-nokori16-2026-09-19.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDFPRICE(DATE(2009,5,31), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '2'; 式 = '=ODDFPRICE(DATE(2009,5,31), DATE(2015,2,28), DATE(2008,12,5), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '3'; 式 = '=ODDFPRICE(DATE(2009,5,31), DATE(2015,2,28), DATE(2008,11,28), DATE(2009,8,31), 0, 0.05, 100, 4, 1)' },
  @{ 番 = '4'; 式 = '=ODDFPRICE(DATE(2009,5,31), DATE(2015,2,28), DATE(2008,11,28), DATE(2009,8,31), 0.045, 0, 100, 4, 1)' },
  @{ 番 = '5'; 式 = '=ODDFPRICE(DATE(2009,5,31), DATE(2015,2,28), DATE(2008,11,28), DATE(2009,8,31), 0.045, 0.05, 100, 4, 1)' },
