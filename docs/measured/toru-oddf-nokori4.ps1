# toru-oddf-nokori4.ps1 -- ★ODDF の 残り 1本 と ODDL の 6本を 実Excel に 聞く★（2026-09-18）
#
...
$出 = Join-Path $ここ 'golden-oddf-nokori4-2026-09-18.tsv'
...
# ══ ★紙から 拾った 問い★ ══
$式たち = @(
  @{ 番 = '1'; 式 = '=ODDLPRICE(DATE(2009,5,30), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '2'; 式 = '=ODDLPRICE(DATE(2009,5,30), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '3'; 式 = '=ODDLPRICE(DATE(2009,5,30), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '4'; 式 = '=ODDLPRICE(DATE(2009,5,31), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '5'; 式 = '=ODDLPRICE(DATE(2009,5,31), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '6'; 式 = '=ODDLPRICE(DATE(2009,5,31), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '7'; 式 = '=ODDLPRICE(DATE(2009,6,1), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '8'; 式 = '=ODDLPRICE(DATE(2009,6,1), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '9'; 式 = '=ODDLPRICE(DATE(2009,6,1), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '10'; 式 = '=ODDLPRICE(DATE(2009,6,30), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '11'; 式 = '=ODDLPRICE(DATE(2009,6,30), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '12'; 式 = '=ODDLPRICE(DATE(2009,6,30), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '13'; 式 = '=COUPDAYBS(DATE(2009,5,30), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '14'; 式 = '=COUPDAYS(DATE(2009,5,30), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '15'; 式 = '=COUPDAYBS(DATE(2009,5,31), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '16'; 式 = '=COUPDAYS(DATE(2009,5,31), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '17'; 式 = '=COUPDAYBS(DATE(2009,6,1), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '18'; 式 = '=COUPDAYS(DATE(2009,6,1), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '19'; 式 = '=COUPDAYBS(DATE(2009,6,30), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '20'; 式 = '=COUPDAYS(DATE(2009,6,30), DATE(2009,8,31), 4, 0)' },
  @{ 番 = '21'; 式 = '=ODDLPRICE(DATE(2009,7,15), DATE(2009,11,30), DATE(2008,11,30), 0.045, 0, 100,4,0)' },
  @{ 番 = '22'; 式 = '=ODDLPRICE(DATE(2009,7,15), DATE(2009,11,30), DATE(2008,11,30), 0, 0.05, 100,4,0)' },
  @{ 番 = '23'; 式 = '=ODDLPRICE(DATE(2009,7,15), DATE(2009,11,30), DATE(2008,11,30), 0.045, 0.05, 100,4,0)' },
  @{ 番 = '24'; 式 = '=ODDLPRICE(DATE(2009,3,10), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,2)' },
  @{ 番 = '25'; 式 = '=ODDLPRICE(DATE(2009,3,10), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,2)' },
  @{ 番 = '26'; 式 = '=ODDLPRICE(DATE(2009,3,10), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,2)' },
  @{ 番 = '27'; 式 = '=ODDLPRICE(DATE(2009,3,10), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0, 100,4,3)' },
  @{ 番 = '28'; 式 = '=ODDLPRICE(DATE(2009,3,10), DATE(2009,8,31), DATE(2008,11,30), 0, 0.05, 100,4,3)' },
  @{ 番 = '29'; 式 = '=ODDLPRICE(DATE(2009,3,10), DATE(2009,8,31), DATE(2008,11,30), 0.045, 0.05, 100,4,3)' }
)
